...
class Basenet(nn.Module):
    def __init__(self, args):
        ...
        self.input_dim = args.input_dim
        self.fc0 = nn.Linear(self.input_dim, args.embedding_dim)
...
class Hypernet(nn.Module):
    ...
    '''
    def __init__(
            self, args, n_usrs, usr_used,  device, n_classes = 3,  in_channels=3, n_kernels=16, hidden_dim=100,
